...
contract NftMarketplace is ReentrancyGuard {
    ...
    function listItem(
        ...
        /** 2 way to do it
         * 1. Send the NFT to the contract. Trandfer -> Contract "hold" the NFT.
         * 2. Owners can still hold their NFT, and give the marketplace approval
         * to sell the NFT for them
         *  --> We will use the second option which is cheaper
         */
        IERC721 nft = IERC721(nftAddress);
    ...
    function getListing(address nftAdrress, uint256 tokenId)
        external
        view
        returns (Listing memory)
    {
        return s_listings[nftAdrress][tokenId];
    }
